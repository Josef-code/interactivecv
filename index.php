    ...
    <header class="d-print-none">
      <div class="container text-center text-lg-left">
        <div class="py-3 clearfix">
          <h1 class="site-title mb-0">Joseph Bassey</h1>
          <div class="site-nav">
            <nav role="navigation">
...
<div class="cover shadow-lg bg-white">
  ...
  <div class="about-section pt-4 px-3 px-lg-4 mt-1">
    <div class="row">
      <div class="col-md-6">
        ...
        <p>Hello! I’m Joseph Bassey. I am passionate about software development. I am a skilled Backend Developer</p>
      </div>
      <div class="col-md-5 offset-md-1">
        <div class="row mt-2">
          ...
          <div class="col-sm-8">
            <div class="pb-1 text-secondary">Jbbliss9@gmail.com</div>
          </div>
          <div class="col-sm-4">
            <div class="pb-1">Phone</div>
          </div>
          <div class="col-sm-8">
            <div class="pb-1 text-secondary">+2348163103910</div>
          </div>
          <div class="col-sm-4">
            <div class="pb-1">Address</div>
          </div>
          <div class="col-sm-8">
            <div class="pb-1 text-secondary">Calabar, Nigeria.</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-6">
        <div class="mb-2"><span>HTML</span>
          <div class="progress my-1">
            <div class="progress-bar bg-danger" role="progressbar" data-aos="zoom-in-right" data-aos-delay="100" data-aos-anchor=".skills-section" style="width: 90%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
        ...
        <div class="mb-2"><span>JavaScript</span>
          <div class="progress my-1">
            <div class="progress-bar bg-warning" role="progressbar" data-aos="zoom-in-right" data-aos-delay="300" data-aos-anchor=".skills-section" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        ...
        <div class="mb-2"><span>Figma</span>
          <div class="progress my-1">
            <div class="progress-bar bg-warning" role="progressbar" data-aos="zoom-in-right" data-aos-delay="600" data-aos-anchor=".skills-section" style="width: 80%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="contant-section px-3 px-lg-4 pb-4" id="contact">
    ...
    <form action="contact.php" method="POST">
      ...
      <div class="col">
        <div class="mt-2">
          ...
          <div class="pb-2 text-secondary">Calabar, Cross River State, Nigeria</div>
          <h3 class="h6">Phone</h3>
          <div class="pb-2 text-secondary">+2348163103910</div>
          <h3 class="h6">Email</h3>
          <div class="pb-2 text-secondary">Jbbliss9@gmail.com</div>
        </div>
      </div>
    ...
    <footer class="pt-4 pb-4 text-muted text-center d-print-none">
      <div class="container">
        <div class="my-3">
          <div class="h4">Joseph Bassey</div>
        ...
        <div class="text-small">
          <div class="mb-1">&copy; HNG Resume. All rights reserved.</div>
          <div>Design by Joseph</a></div>
        </div>
      </div>
    </footer>
